/**
 * Exemplo de teste para o serviço de leitor
 *
...
describe("LeitorRepository", () => {
  ...
  it("✅ deve criar leitor em banco de dados", async () => {
    ...
    // const leitor = await repository.criarLeitor("Nome", "senha", "REGULAR", "email@test.com");
  ...
  it("✅ deve recuperar leitor por ID do banco", async () => {
    // Requer banco real
    // const repository = new LeitorRepository();
    // const leitor = await repository.obterLeitorPorId(idCriado);
    // expect(leitor).toBeDefined();
  });
