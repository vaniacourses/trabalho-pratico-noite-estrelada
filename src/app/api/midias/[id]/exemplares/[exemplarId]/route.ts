...
// GET /api/midias/:id/exemplares/:exemplarId
export async function GET(
    ...
    try {
        ...
        const exemplar = await exemplarService.obterExemplarPorId(exemplarId);

        return NextResponse.json({sucesso: true, dados: exemplar}, {status: 200});
    } catch (erro: any) {
        ...
        console.error("Erro ao buscar exemplar:", erro);
        return NextResponse.json(
            {
                sucesso: false,
...
// PUT /api/midias/:id/exemplares/:exemplarId
export async function PUT(
    ...
    try {
        ...
        const exemplar = await exemplarService.atualizarExemplar(exemplarId, {
            codigo: body.codigo,
            estado: body.estado,
        });
