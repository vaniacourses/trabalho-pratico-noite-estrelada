...
export default async function ExemplarDetailPage({ params }: ExemplarDetailPageProps) {
  const { id, exemplarId } = (await params) as { id: string; exemplarId: string };

  console.log('MidiaExemplarDetail params id, exemplarId=', id, exemplarId);
        ...
        <div className="max-w-3xl mx-auto p-6">
          <Card>
            ...
            <CardFooter className="flex justify-end">
              <Link href={`/midias/${id}/exemplares`}>
      ...
      <div className="max-w-6xl mx-auto space-y-6 p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href={`/midias/${id}/exemplares/${exemplar.id}/edit`}>
